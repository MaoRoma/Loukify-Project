...
import { sendOtp, verifyOtp, signOut, getCurrentUser, refreshToken, signup, login, passwordResetRequest, passwordResetConfirm, initiateGoogleAuth, handleGoogleCallback, emailValidator, otpValidator, signupValidator } from '../controllers/authController.js';
import { authenticateToken, requireEmailVerified } from '../middlewares/authMiddleware.js';
